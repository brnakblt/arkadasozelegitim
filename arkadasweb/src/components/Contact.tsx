...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-neutral-dark relative overflow-hidden" aria-labelledby="contact-heading">
      {/* Background Pattern */}
      <div className="absolute inset-0">
        <svg className="w-full h-full opacity-10" viewBox="0 0 1000 1000" fill="none">
          <path
            d="M0 500C200 400 400 600 600 500C800 400 1000 600 1000 500V1000H0V500Z"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 id="contact-heading" className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-white mt-4 mb-6">
            Bizimle İletişime
          ...
          <p className="font-body text-lg text-white/80 max-w-3xl mx-auto leading-relaxed">
            Çocuğunuzun eğitim yolculuğuna başlamak için bugün bizimle iletişime geçin. 
          ...
          <div className="bg-white rounded-3xl p-8 card-shadow">
            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="name" className="block font-body font-medium text-neutral-dark mb-2">
                    Ad Soyad *
                  </label>
                  <input
                    type="text"
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="font-body text-white/80">info@arkadasozelegitim.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="font-body text-white/60 text-sm">WhatsApp mevcut</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-body font-semibold text-white mb-1">Adres</h4>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="font-body font-semibold text-white text-lg">0555 987 65 43</span>
              </div>
            </div>
          </div>
        </div>
